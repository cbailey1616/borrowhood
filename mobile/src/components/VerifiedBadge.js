...
function IdentityInfoBadge({ size }) {
  ...
  return <>
    ...
    {visible && <ActionSheet isVisible onClose={() => setVisible(false)}
      ...
      message={`This person’s identity has been verified. It helps you know who you’re sharing with. Identity verification is powered by Stripe Identity.${!verified ? '\n\nBuild trust in your town. Get verified with a quick ID and selfie check.' : ''}`}
      cancelLabel="Got it"
