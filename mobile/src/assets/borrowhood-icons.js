...
const DRAWINGS = {
  ...
  'thumbs-up': thumbUp,
  'balance-scale': c => p('M16 4V26M7 9H25M11 28H21')
    + circle(16, 6, 2, accent(c))
    + p('M7 10L3 19H11ZM25 10L21 19H29Z', panel(c))
    + p('M3 19C3 25 11 25 11 19M21 19C21 25 29 25 29 19', accent(c)),
